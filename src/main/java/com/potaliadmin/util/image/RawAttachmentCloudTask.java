 ...
 */
public class RawAttachmentCloudTask implements Callable<Attachment> {
  ...
  public RawAttachmentCloudTask(String cloudName, String apiKey, String apiSecret,
  ...
  public Attachment call() throws Exception {
    ...
    try {
      ...
      String folder = DefaultConstants.DOC + File.separator + relativePath;
